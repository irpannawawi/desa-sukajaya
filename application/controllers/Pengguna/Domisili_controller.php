...
class Domisili_controller extends CI_Controller {
	...
	{
        $data['domisili'] = $this->domisili_model->get_where(['nik_pemohon'=>$_SESSION['nik']])->result();
        $data['_view'] = 'pengguna/domisili/data_domisili';
    ...
    public function store()
    {
        ...
        if($res){
            ...
            return redirect('pengguna/surat_domisili');
        }
    }
    ...
    public function edit($id)
	{
        ...
        $data['_view'] = 'pengguna/domisili/edit_domisili';
		$this->load->view('templates/main_layout', $data);
	}
