...
class Kematian_controller extends CI_Controller {
	...
	{
        $data['kematian'] = $this->kematian_model->get_where(['nik_pemohon'=>$_SESSION['nik']])->result();
        $data['_view'] = 'pengguna/kematian/data_kematian';
    ...
    public function store()
    {
        ...
        if($res){
            ...
            return redirect('pengguna/surat_kematian');
        }
    }
    ...
    public function edit($id)
	{
        ...
        $data['_view'] = 'pengguna/kematian/edit_kematian';
		$this->load->view('templates/main_layout', $data);
	}
