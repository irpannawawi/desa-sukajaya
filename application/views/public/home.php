		...
		<div class="row content">
			<div class="col-lg-6 mx-auto">
				...
				<ol class="text-justify">
					<li class="mt-3">
						<p style="text-align: justify;">Meningkatkan potensi sumber daya manusia <br>
							Pembangunan yang menekankan pada kualitas Sumber Daya Manusia (SDM) ini ditandai dengan membaiknya taraf pendidikan dan derajat kesehatan penduduk, yang didukung oleh meningkatnya ketersediaan dan kualitas pelayanan sosial dasar bagi masyarakat agar lebih produktif serta berdaya saing untuk mencapai kehidupan yang lebih makmur dan sejahtera.</p>
					</li>

					<li class="mt-3">
						<p style="text-align: justify;">Membentuk tata kelola pemerintahan desa yang efisien dan efektif serta penguatan kemitraan antara pemerintah dan masyarakat.</p>
					</li>

					<li class="mt-3">
						<p style="text-align: justify;">Mengoptimalkan pelayanan prima kepada masyarakat untuk mempercepat daya guna dan hasil guna.</p>
					</li>

					<li class="mt-3">
						<p style="text-align: justify;">Meningkatkan ketersediaan sarana dan prasarana desa serta kualitas infrastruktur.</p>
					</li>

					<li class="mt-3">
						<p style="text-align: justify;">Bersama masyarakat dan kelembagaan masyarakat dalam mewujudkan Desa Sukajaya yang aman, tentram, dan damai.</p>
					</li>

					<li class="mt-3">
						<p style="text-align: justify;">Meningkatkan percepatan pembangunan desa.</p>
					</li>

					<li class="mt-3">
						<p style="text-align: justify;">Membangun perekonomian desa yang baik dan mapan.</p>
					</li>
				</ol>
				</p>
			</div>
